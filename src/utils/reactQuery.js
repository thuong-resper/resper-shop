...
export const usePost = (url, params, updater) => {
	return useGenericMutation((data) => axiosClient.post(url, data), url, params, updater)
}

export const useUpdate = (url, params, updater) => {
	return useGenericMutation((data) => axiosClient.patch(url, data), url, params, updater)
}

export const useDelete = (url, params, updater) => {
	return useGenericMutation((id) => axiosClient.delete(`${url}/${id}`), url, params, updater)
}
