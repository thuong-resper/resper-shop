...
const fetchedCategories = [
  {
    label: 'Đồng hồ thời trang nổi bật nhất',
    id: '61376edaa8d3c977efbcfa08',
    index: 0,
  },
  {
    label: 'Đồng hồ thông minh nổi bật nhất',
...
const TopTenWatch = () => {
  ...
  return (
    <>
      <div className="skeleton-p skeleton-p-top color-watch">
        <div className="tab">
