...
import { formItemLayout, laptopCpu, laptopRam, laptopRes, laptopRom, laptopSc } from 'staticOptions'
...
export default function FormProductCreateLaptop() {
	...
	return (
		<>
			...
			<Title level={4}>Thêm mới Laptop</Title>
			<Form
				form={form}
				{...formItemLayout}
				onFinish={onFinish}
			...
			>
				...
				<Form.Item
					name="rom"
					label="Ổ cứng"
					rules={[{ required: true, message: 'Vui lòng chọn loại ổ cứng!' }]}
				>
					<Select placeholder="Chọn loại ổ cứng" mode="multiple">
						{laptopRom.map((v, i) => (
							<Option key={i} value={v.value}>
								{v.label}
							</Option>
